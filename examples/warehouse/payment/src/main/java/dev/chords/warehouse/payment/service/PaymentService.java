package dev.chords.warehouse.payment.service;

import dev.chords.warehouse.proto.PaymentGrpc;
import dev.chords.warehouse.proto.PaymentOuterClass;
import dev.chords.warehouse.proto.PaymentOuterClass.Empty;
import io.grpc.Grpc;
...
public class PaymentService {
    ...
    static class PaymentImpl extends PaymentGrpc.PaymentImplBase {
        ...
        @Override
        public void compensateTakeMoneyFromCustomer(dev.chords.warehouse.proto.PaymentOuterClass.Empty request, StreamObserver<PaymentOuterClass.Empty> responseObserver) {
