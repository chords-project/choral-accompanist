...
func initializeDatabase(url string) (*mongo.Client, func()) {
	...
	slog.Info("Attempting connection to mongodb", slog.String("url", uri))
	...
	slog.Info("Successfully inserted test data into museum DB")
	...
	slog.Info("Successfully inserted test data into restaurant DB")
