...
jib {
    to.image = "europe-west1-docker.pkg.dev/chords-microservice-444208/webshop-repo/travel-sidecar-reservation"
}
...
application {
    ...
    mainClass = "dev.chords.travel.reservationservice.Main"
}
